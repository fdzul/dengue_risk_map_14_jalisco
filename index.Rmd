...
if(as.vector(Sys.info()["sysname"]) == "Darwin"){
    ...
    load("C:/Users/HOME/Dropbox/hotspots_2022/8.RData/cases_hotspots_agebs19.RData")
    ...
    # Step 2. load the vector hotspots
    load("D:/OneDrive/proyects/hotspots_eggs/8.RData/14_jalisco/betas/14_jalisco_zinb1_betas.RData")
...
```{r, hotspots_dengue_guadalajara, echo=FALSE}
...
### [**Ciudad Guzman**]{style="color:#990000"}

```{r, hotspots_dengue_cd_guzman, echo=FALSE}
hotspots_map(cve_ent = "14",
